...
export default {
  ...
  AUDITION_FORM: {
    ...
    TEXT_AREA: {
      LABELS: {
        NOTES: "notes-text-area-label",
      },
      NOTES: "notes-text-area",
    },
    DROPDOWNS: {
      LABELS: {
        TYPE: "type-dropdown-label",
        STATUS: "status-dropdown-label",
      },
      OPTIONS: {
        TYPE: "type-dropdown-option-",
        STATUS: "status-dropdown-option-",
      },
      TYPE: "type-dropdown",
